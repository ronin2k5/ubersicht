command: "/Users/ronin/.rvm/rubies/ruby-2.5.0/bin/gem outdated | awk '{print $1;}'"
...
update: (output, domElement) ->
  ...
  domElement.innerHTML = '<div class="container"><div class="widget-title">Outdated Gems</div><div id="ports" class="list"></div></div>'
